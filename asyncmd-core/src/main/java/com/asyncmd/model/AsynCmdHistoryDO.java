 ...
 *
 * @author wangwendi
 * @version $Id: AsynCmdHistoryDO.java, v 0.1 2018年09月20日  wangwendi Exp $
 */
public class AsynCmdHistoryDO implements Serializable {

    private static final long serialVersionUID = 5933451300569104424L;

    public static final String TABLE_NAME = "asyn_cmd_history";
    /**
     * 唯一id
     */
    private Long cmdId;
